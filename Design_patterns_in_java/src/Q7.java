...
class HR_Directory implements Directory{
    ...
    @Override
    public void showDirectoryDetails() {
        System.out.println("HR Emplpoyee Directory");
...
public class Q7{
    ...
    public static void main(String[] args) {
        ...
        technical emp1= new technical("Arun","Python");
        technical emp2= new technical("Arnav", "Java");

        hr emp3= new hr("Daksh", "Sales");
        hr emp4= new hr("Kanak","Recruiter");
